...
${txtbld}OPTIONS${txtrst}:
	...
	-P	The way to preprocess data before clustering.
		...
		3 (default): means values in each row are divided by the
	...
	-l	Parameters for s-plot heatmapS (-f is not needed). 
		...
		[Default: '-A 90 -T 1.5 -V 0.5 -l top -v 18 -u 15 -F 9 
...
ylab='Variable'
mainT=''
ly_default='-A 90 -T 1.5 -V 0.5 -l top -v 19 -u 15 -F 9 -j TRUE -M yellow -x green -y red -Z TRUE'
ly=''
ist='FALSE'
